          ...
          // { test: /\.css$/, loader: 'style-loader!css-loader'},
            {
                test: /\.less$/,
                /* 这里要加入
                -autoprefixer 这个表示不要移除浏览器前缀（-webkit-）的样式，默认在压缩的时候会去掉前缀相关的样式
            ...
            {
                test: /\.(jpg|png|gif)$/,
                loader: 'url?limit=8192&name=img/[folder]/'+ nameStr+'.[ext]!image-webpack?{progress:true, optimizationLevel: 1, interlaced: false, mozjpeg: {quality: 80}}'
